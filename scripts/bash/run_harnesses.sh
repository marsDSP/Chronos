...
# ── The 19 correctness harnesses (gated) and 4 benchmarks (informational) ─
CORRECTNESS_HARNESSES=(
    ...
    oversized_block_check engine_skeleton_check chain_parity
    bypass_null_check crossfade_parity dither_check f2_oracle_check
)
